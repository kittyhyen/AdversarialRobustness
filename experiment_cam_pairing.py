...
# %%
parser = argparse.ArgumentParser('CAM Pairing ADT with Various Aug')
...
parser.add_argument('--cam_pairing_lambda', type=float, default=1.)
...
save_name = "cam_pairing_%g_aug_%s" % (
...
def main():
    ...
    for epoch in range(args.epoch):
        ...
        for data in train:
            ...
            total_loss = ce_loss + args.cam_pairing_lambda * cam_pairing_loss
        ...
        print_str = "[Epoch %3d] CELoss: %.8f  CAMLoss: %.8f  " % (
            epoch + 1, eval_dict['TrainCELoss'], eval_dict['TrainCAMLoss']
        )
